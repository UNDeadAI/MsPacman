package MsPacmanExample.pacman.controllers;
...
public abstract class Controller<T> implements Runnable
{
	 ...
	 * 			MsPacmanExample.pacman.controllers.examples
	 * Your controllers must be in the files: MsPacmanExample.pacman.entries.MsPacmanExample.pacman.MyPacMan.java for Pac-Man controllers or
	 * MsPacmanExample.pacman.entries.ghosts.MyGhosts.java for ghosts controllers.
	 *
	 * @param game A copy of the current game
	 * @param timeDue The time the next move is due
