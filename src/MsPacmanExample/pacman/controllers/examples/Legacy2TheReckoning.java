        ...
        for(GHOST ghost : GHOST.values())      
        {
        	if(game.doesGhostRequireAction(ghost))
        	{
        		...
        		//if edible or Ms Pac-Man is close to power pill, move away from Ms Pac-Man
        			...
        			myMoves.put(ghost,game.getApproximateNextMoveAwayFromTarget(currentIndex,pacmanIndex,game.getGhostLastMoveMade(ghost),DM.PATH));      			//move away from ms MsPacmanExample.pacman
        		//else go towards Ms Pac-Man
        		else        		
        			myMoves.put(ghost,game.getApproximateNextMoveTowardsTarget(currentIndex,pacmanIndex,game.getGhostLastMoveMade(ghost),DM.PATH));       			//go towards ms MsPacmanExample.pacman
        	}
        }
