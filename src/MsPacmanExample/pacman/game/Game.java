package MsPacmanExample.pacman.game;

import java.util.BitSet;
import java.util.EnumMap;
import java.util.Random;
import java.util.Map.Entry;
import MsPacmanExample.pacman.game.Constants.DM;
import MsPacmanExample.pacman.game.Constants.MOVE;
import MsPacmanExample.pacman.game.internal.Ghost;
import MsPacmanExample.pacman.game.internal.Maze;
import MsPacmanExample.pacman.game.internal.Node;
import MsPacmanExample.pacman.game.internal.PacMan;
import MsPacmanExample.pacman.game.internal.PathsCache;
...
public final class Game
{
	...
	//the data relating to MsPacmanExample.pacman and the ghosts are stored in respective data structures for clarity
	...
	/**
	 * Returns whether MsPacmanExample.pacman was eaten in the last time step
	 * 
	 ...
	 *
	 * @return the MsPacmanExample.pacman current node index
	 */
	 ...
	 * Current node index of Ms Pac-Man.
	 *
	 * @return the MsPacmanExample.pacman last move made
	 */
